...
{
    use InteractsWithForms, WorldSlotTrait, NexosPlayTrait, WithFileUploads;
     ...
     * @return void
     */
    public function loadProviderNexosPlay($type)
    {
        self::getProviderNexosPlay($type);
        Notification::make()
            ->title('Sucesso')
            ->body('Provedores NexosPlay Carregados com sucesso')
            ->success()
            ->send();
    }
     ...
     * @return void
     */
    public function loadGamesNexosPlay()
    {
        self::getGamesNexosPlay();
        Notification::make()
            ->title('Sucesso')
            ->body('Jogos NexosPlay Carregados com sucesso')
            ->success()
            ->send();
    }
